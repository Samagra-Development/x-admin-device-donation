    ...
    >
      {isSmall ? (
        ...
        <Datagrid rowClick='edit'>
          ...
          <TextField label='Students without smartphone' source='student_count_no_smartphone' />   
        </Datagrid>
      )}
    </List>
  );
  ...
  <Edit {...props} title={<Title/>}>      
    <SimpleForm toolbar={<EditNoDeleteToolbar />}>
      ...
      <div className={classes.grid}>        
        ...
        <TextField label='District' source='district' disabled variant='outlined'/> 
        <td>Block</td>
        <td>Pincode</td>
        <td>School Name</td>  
        <TextField label='Block' source='block' disabled variant='outlined' />
        <TextField label='Pincode' source='pincode' disabled variant='outlined' />   
        <TextField label='School Name' source='schoolname' disabled variant='outlined' />        
      </div>            
